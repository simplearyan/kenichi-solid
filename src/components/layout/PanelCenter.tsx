  ...
  return (
    <main class="w-full h-full flex flex-col gap-2 relative">
      <div class="flex-1 glass-panel bg-surface border border-border rounded-lg md:rounded-xl flex items-center justify-center relative overflow-hidden p-1 md:p-2 min-h-0">
        <div id="stats-overlay" class="absolute top-2 left-2 md:top-3 md:left-3 bg-background/80 text-primary font-mono text-[9px] md:text-[10px] px-2 py-1 rounded-md z-10 border border-primary/30 backdrop-blur-md">
          <span>1920x1080</span> | <span>60</span> FPS
        </div>
